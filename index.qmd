...
freq_line_plot <- ggplot(data = long_graphingdata,
  ...
  ylab("(Simulated) Sound pressure level at 10 m [dB(Z)]")
...
combinations$effsize <- c(NA, 2.5, 2.1, 1.2,
                          NA, NA, 0.1, 0.75,
                          NA, NA, NA, 0.5,
                          NA, NA, NA, NA)
...
combinations$group2_n <- c("", "", "", "",
                          ...
                          "10", "19", "", "",
                          "10", "19", "22", "")
combinations$treatment_labels <- c("Control", "", "", "",
                          "", "DP", "", "",
                          "", "", "PJ", "",
                          "", "", "", "SP")
 
# Heatmap 
heatmaps <- ggplot(combinations) + 
    ...
    geom_text(mapping = aes(x = group1, y = group2,
      ...
      geom_text(mapping = aes(x = group1, y = group2,
        ...
        geom_text(mapping = aes(x = group1, y = group2,
                          ...
                          hjust = "center",
                          vjust = "center"))+
    geom_tile(mapping = aes(x = group1, y = group2, fill= effsize)) +
...
grid.arrange(freq_line_plot, heatmaps)
...
OU Libraries Digital Scholarship and Data Services open office hours (drop in) and contact form

![[libraries.ou.edu/data](https://libraries.ou.edu/data)](qrcode_dsds.png)


## Please provide feedback

![[ou.libwizard.com/f/datasurvey](https://ou.libwizard.com/f/datasurvey)](qrcode_ou-libwizard-com.png)
