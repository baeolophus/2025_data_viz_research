...
## Don't let the graph get in the way of the goal
...
Few, 2012, *Show me the numbers: designing tables and graphs to enlighten, 2nd ed*. Burlingame, CA: Analytics Press.
...
-   Use common baselines wherever possible because of perception limits (207).
...
- Make text, symbols, lines big enough to read
